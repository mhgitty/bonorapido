...
export function Breadcrumbs({ crumbs }: { crumbs: Crumb[] }) {
  return (
    <nav aria-label="Ruta de navegación" style={{ fontSize: '13px', color: 'var(--text-faint)', marginBottom: '20px', display: 'flex', alignItems: 'baseline', flexWrap: 'wrap', rowGap: '2px' }}>
      {crumbs.map((crumb, i) => {
