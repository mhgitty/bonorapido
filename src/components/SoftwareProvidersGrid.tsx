        ...
        <div key={provider._id} style={{
          ...
          <div style={{ padding: '14px 16px', flex: 1, display: 'flex', flexDirection: 'column' }}>
            ...
            <div style={{ flex: 1, marginBottom: '12px' }}>
              ...
              <StatRow icon="play-circle" label="Número de tragamonedas" value={provider.amountOfSlots} />
              <StatRow icon="gamepad"  label="Categorías de juegos" value={provider.gameCategories} />
            </div>
