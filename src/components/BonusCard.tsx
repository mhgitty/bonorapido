...
export function BonusCard({
  title, slug,
  oddsBonusTitel, minimumOdds, minimumIndbetaling, gennemspilskrav, market,
  ...
  const reviewUrl = bookmaker?.slug?.current
    ? `/resenas/${bookmaker.slug.current}`
    : null
      ...
      <div style={{
        ...
        <div className="bonus-card-middle" style={{
          ...
          <div className="bonus-card-stats" style={{
            ...
            <StatRow label="Requisitos de apuesta" value={gennemspilskrav} />
            <StatRow label="Depósito mín."         value={minimumIndbetaling != null ? `${minimumIndbetaling} ${market === 'ar' ? 'ARS' : market === 'mx' ? 'MXN' : '€'}` : undefined} />
            <StatRow label="Cuota mín."            value={minimumOdds} />
          </div>
