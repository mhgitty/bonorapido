...
export function PaymentMethodHero({
  ...
  const stats: { label: string; value: string | null | undefined }[] = [
    { label: 'Tipo de pago',        value: paymentCategory },
    { label: 'Tiempo de retirada',  value: withdrawalTime },
    { label: 'Comisiones',          value: transactionFees },
    { label: 'Válido para bonos', value: eligibleForBonuses },
  ]
