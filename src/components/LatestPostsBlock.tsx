...
export function LatestPostsBlock({ value, posts }: LatestPostsBlockProps) {
  const { title = 'Últimas guías y artículos', count = 4, showViewAll = true } = value
  ...
  return (
    <div style={{ margin: '40px 0' }}>
      ...
      <div style={{
        ...
        {showViewAll && (
          <Link href="/noticias/" style={{ fontSize: '13px', color: 'var(--green)', textDecoration: 'none', fontWeight: 500 }}>
            Ver todo →
          </Link>
        )}
      </div>
