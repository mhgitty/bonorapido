...
export function BonusHero({
  ...
  minimumOdds, minimumIndbetaling, gennemspilskrav, currency = '€',
  ...
  return (
    <section className="hero-section" style={{
      ...
      <div style={{ maxWidth: '1250px', margin: '0 auto' }}>
        ...
        <Breadcrumbs crumbs={[{ label: 'Inicio', href: '/' }, { label: 'Bonos', href: bonusListHref }, { label: title }]} />
        ...
        <div className="bonus-stats-grid">
          ...
          {bonuskode ? (
            <div style={{
              background: 'rgba(255,144,25,0.08)',
              border: '1px dashed rgba(255,144,25,0.5)',
              borderRadius: '10px', padding: '10px 14px',
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '10px', minWidth: 0 }}>
                ...
                <div style={{ minWidth: 0 }}>
                  <div style={{ fontSize: '10px', color: 'var(--green)', textTransform: 'uppercase', letterSpacing: '0.4px', marginBottom: '1px' }}>Código de bono</div>
            ...
            <StatBox label="Código de bono" value={null} icon={
