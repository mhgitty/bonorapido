...
export function PaymentMethodsGrid({
  methods,
  hrefPrefix = '/casinos-online/metodos-de-deposito',
}: {
        ...
        <div key={method._id} style={{
          ...
          <div style={{ padding: '14px 16px', flex: 1, display: 'flex', flexDirection: 'column' }}>
            ...
            <div style={{ flex: 1, marginBottom: '12px' }}>
              <StatRow icon="card"         label="Comisiones"   value={method.transactionFees} />
              <StatRow icon="clock-circle" label="Tiempo de retirada" value={method.withdrawalTime} />
              <StatRow icon="gift"         label="Válido para bonos" value={method.eligibleForBonuses} />
            </div>
