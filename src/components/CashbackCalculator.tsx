      ...
      >
        <div className="wcalc-inputs" style={{ padding: '22px 24px' }}>
          <div className="ccalc-fields">
            <div>
              <label style={labelStyle} htmlFor="ccalc-loss">Pérdida neta</label>
            ...
            <div>
              <label style={labelStyle} htmlFor="ccalc-pct">Porcentaje de cashback (%)</label>
              <input
                id="ccalc-pct"
            ...
            <div>
              <label style={labelStyle} htmlFor="ccalc-cap">Límite de cashback (opcional)</label>
              <div style={{ position: 'relative' }}>
                <span style={{
                  position: 'absolute', left: '12px', top: '50%', transform: 'translateY(-50%)',
                  fontSize: '15px', fontWeight: 600, color: 'var(--text-faint)', pointerEvents: 'none',
        ...
        >
          ...
          <p style={{ margin: '12px 0 0', fontSize: '12.5px', color: 'var(--text-muted)', lineHeight: 1.5 }}>
            {pct || 0}% de {fmt(loss, currency)} = <strong>{fmt(raw, currency)}</strong>
            {capped && <> — reducido a {fmt(capValue, currency)} por el límite de cashback</>}.
          </p>
        </div>
      </div>
    </div>
