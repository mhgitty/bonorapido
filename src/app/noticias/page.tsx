...
export const metadata: Metadata = {
  title: 'Noticias y guías — Bonorapido',
  description: 'Explora todas las guías de casino, consejos sobre bonos y noticias del equipo de Bonorapido.',
  alternates: { canonical: `${BASE}/noticias/` },
  openGraph: {
    title: 'Noticias y guías — Bonorapido',
    description: 'Explora todas las guías de casino, consejos sobre bonos y noticias del equipo de Bonorapido.',
    url: `${BASE}/noticias/`,
      ...
      <div style={{ background: 'var(--bg-hero)', padding: '48px 0 40px' }}>
        <div style={{ maxWidth: '1250px', margin: '0 auto', padding: '0 15px' }}>
          ...
          <p style={{ fontSize: '16px', color: 'var(--text-muted)', maxWidth: '560px', lineHeight: 1.65 }}>
            Reseñas de casinos, análisis de bonos y guías de estrategia del equipo de Bonorapido.
          </p>
        </div>
      </div>
          ...
          return (
            <section key={cat._id} style={{ marginBottom: '48px' }}>
              ...
              <div style={{
                ...
                <Link href={`/noticias/${cat.slug.current}/`} style={{
                  fontSize: '13px',
                  color: 'var(--green)',
                  textDecoration: 'none',
                  fontWeight: 500,
