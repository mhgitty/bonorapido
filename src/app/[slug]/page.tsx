...
export default async function SlugPage({ params }: Props) {
    ...
    const jsonLdGraph: object[] = [
      ...
      },
      {
        ...
        author: author
          ...
          : { '@type': 'Organization', name: 'Bonorapido' },
        publisher: {
          '@type': 'Organization',
          name: 'Bonorapido',
          url: BASE,
      ...
      <>
        ...
        <div style={{ background: 'var(--bg-hero)', borderBottom: '1px solid var(--border)', padding: '40px 15px 32px' }}>
          <div style={{ maxWidth: '1250px', margin: '0 auto' }}>
            ...
            {post.category && (
              <div style={{ display: 'inline-flex', alignItems: 'center', gap: '5px', background: 'rgba(255,144,25,0.1)', color: 'var(--green)', fontSize: '12px', fontWeight: 500, padding: '3px 12px', borderRadius: '20px', marginBottom: '16px' }}>
  ...
  const breadcrumbItems = [{ name: 'Inicio', item: BASE }]
