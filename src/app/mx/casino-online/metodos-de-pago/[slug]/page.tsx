...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const canonical = `${BASE}/mx/casino-online/metodos-de-pago/${slug}/`
...
export default async function AuPaymentSlugPage({ params }: Props) {
  ...
  const jsonLd = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'Métodos de pago', item: `${BASE}/mx/casino-online/metodos-de-pago/` },
      ...
      <div style={{ background: 'var(--bg-hero)', paddingTop: '32px', paddingBottom: '0' }}>
        <div style={{ maxWidth: '1250px', margin: '0 auto', padding: '0 15px' }}>
          <Breadcrumbs crumbs={[
            ...
            { label: 'Métodos de pago', href: '/mx/casino-online/metodos-de-pago/' },
