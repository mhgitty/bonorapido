...
const CANONICAL = `${BASE}/mx/casino-online/resenas/`

export async function generateMetadata(): Promise<Metadata> {
  const page = (await getPageByPathMx(['casino-online', 'resenas']).catch(() => null))
...
export default async function AuReviewsPage() {
  const [pathPage, legacyPage, bookmakers, settings] = await Promise.all([
    getPageByPathMx(['casino-online', 'resenas']).catch(() => null),
  ...
  return (
    <>
      ...
      <HeroSection
        ...
        breadcrumbs={[{ label: 'Inicio', href: '/mx/' }, { label: 'Casino online', href: '/mx/casino-online/' }, { label: 'Reseñas de casinos' }]}
      />
      ...
      <CasinoReviewsArchive casinos={bookmakers as any[]} hrefPrefix="/mx/casino-online/resenas" />
