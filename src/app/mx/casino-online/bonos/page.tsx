...
const CANONICAL = `${BASE}/mx/casino-online/bonos/`

export async function generateMetadata(): Promise<Metadata> {
  const page = await getPageByPathMx(['casino-online', 'bonos']).catch(() => null)
  if (!page) return {}
...
export default async function AuBonusPage() {
  const [page, settings] = await Promise.all([
    getPageByPathMx(['casino-online', 'bonos']).catch(() => null),
