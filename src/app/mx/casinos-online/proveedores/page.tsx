...
import { getPageByPathMx, getSoftwareProvidersMx, getSiteSettings } from '@/lib/sanity'
...
const CANONICAL = `${BASE}/mx/casinos-online/proveedores/`
      ...
      {(providers as any[]).length > 0 && (
        <div className="section" style={{ paddingBottom: page.body ? '0' : undefined }}>
          <SoftwareProvidersGrid
            ...
            hrefPrefix="/mx/casinos-online/proveedores"
          />
        </div>
      )}
