...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const canonical = `${BASE}/mx/casinos-online/proveedores/${slug}/`
...
export default async function AuSoftwareSlugPage({ params }: Props) {
  ...
  const jsonLd = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'Proveedores',      item: `${BASE}/mx/casinos-online/proveedores/` },
      ...
      <div style={{ background: 'var(--bg-hero)', paddingTop: '32px', paddingBottom: '0' }}>
        <div style={{ maxWidth: '1250px', margin: '0 auto', padding: '0 15px' }}>
          <Breadcrumbs crumbs={[
            ...
            { label: 'Proveedores',      href: '/mx/casinos-online/proveedores/' },
            ...
            {provider.casinos.map((casino: any) => (
              <div key={casino._id} style={{
                ...
                <div style={{ display: 'flex', gap: '8px', flexShrink: 0 }}>
                  ...
                  <Link href={`/mx/casinos-online/resenas/${casino.slug.current}/`}
