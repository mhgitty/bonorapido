// Renders the Sanity page at /mx/casinos-online/metodos-de-deposito/ (same as mx/[...slug] would),
...
const CANONICAL = `${BASE}/mx/casinos-online/metodos-de-deposito/`
      ...
      {(methods as any[]).length > 0 && (
        <div className="section" style={{ paddingBottom: page.body ? '0' : undefined }}>
          <PaymentMethodsGrid
            ...
            hrefPrefix="/mx/casinos-online/metodos-de-deposito"
          />
        </div>
      )}
