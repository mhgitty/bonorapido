...
const CANONICAL = `${BASE}/ar/casino-online/bonos/`

export async function generateMetadata(): Promise<Metadata> {
  const page = await getPageByPathAr(['casino-online', 'bonos']).catch(() => null)
  if (!page) return {}
...
export default async function CaBonusPage() {
  const [page, settings] = await Promise.all([
    getPageByPathAr(['casino-online', 'bonos']).catch(() => null),
