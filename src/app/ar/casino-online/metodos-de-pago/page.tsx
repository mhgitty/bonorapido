// Renders the Sanity page at /ar/casino-online/metodos-de-pago/ (same as ar/[...slug] would),
...
const CANONICAL = `${BASE}/ar/casino-online/metodos-de-pago/`
      ...
      {(methods as any[]).length > 0 && (
        <div className="section" style={{ paddingBottom: page.body ? '0' : undefined }}>
          <PaymentMethodsGrid
            ...
            hrefPrefix="/ar/casino-online/metodos-de-pago"
          />
        </div>
      )}
