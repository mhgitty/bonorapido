...
import { getPageByPathAr, getSoftwareProvidersAr, getSiteSettings } from '@/lib/sanity'
...
const SLUG = ['casinos-online', 'proveedores']
const CANONICAL = `${BASE}/ar/casinos-online/proveedores/`
      ...
      {(providers as any[]).length > 0 && (
        <div className="section" style={{ paddingBottom: page.body ? '0' : undefined }}>
          <SoftwareProvidersGrid
            ...
            hrefPrefix="/ar/casinos-online/proveedores"
          />
        </div>
      )}
