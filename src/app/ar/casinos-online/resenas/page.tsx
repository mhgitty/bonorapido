...
const CANONICAL = `${BASE}/ar/casinos-online/resenas/`

export async function generateMetadata(): Promise<Metadata> {
  const page = (await getPageByPathAr(['casinos-online', 'resenas']).catch(() => null))
...
export default async function CaReviewsPage() {
  const [pathPage, legacyPage, bookmakers, settings] = await Promise.all([
    getPageByPathAr(['casinos-online', 'resenas']).catch(() => null),
  ...
  return (
    <>
      ...
      <HeroSection
        ...
        breadcrumbs={[{ label: 'Inicio', href: '/ar/' }, { label: 'Casino online', href: '/ar/casinos-online/' }, { label: 'Reseñas de casinos' }]}
      />
      ...
      <CasinoReviewsArchive casinos={bookmakers as any[]} hrefPrefix="/ar/casinos-online/resenas" />
